#pragma once
  ...
  #define MARAUDER_WAVESHARE_1_47B // Waveshare ESP32-S3 1.47" 172x320 ST7789 (för lokal build)
  ...
  #elif defined(MARAUDER_WAVESHARE_1_47B)
    #define HARDWARE_NAME "Waveshare ESP32-S3 1.47\""
 ...
 //// BOARD FEATURES
  ...
  #ifdef MARAUDER_WAVESHARE_1_47B
    //#define HAS_TOUCH  // No touch on 1.47B
    //#define HAS_FLIPPER_LED
    #define HAS_BT
    #define HAS_BT_REMOTE
    #define HAS_BUTTONS
    #define HAS_SCREEN
    #define HAS_FULL_SCREEN
    //#define HAS_SD    // TODO: Waveshare uses SDIO, not SPI - add SD_MMC support later
    //#define USE_SD
    #define HAS_TEMP_SENSOR
    #define HAS_GPS
    #define HAS_NIMBLE_2
  ...
  #ifdef MARAUDER_WAVESHARE_1_47B
    #define L_BTN -1
    #define C_BTN 0   // Boot button GPIO 0
    #define U_BTN -1
    #define R_BTN -1
    #define D_BTN -1
  ...
  //// DISPLAY DEFINITIONS
    ...
    #if defined(MARAUDER_WAVESHARE_1_47B)
      #define CHAN_PER_PAGE 7
